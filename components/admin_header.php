...
<header class="header">
   ...
   <section class="flex">
      ...
      <form action="search_page.php" method="post" class="search-form">
         <input type="text" name="search" placeholder="pesquise aqui..." required maxlength="100">
      ...
      <div class="profile">
         ...
         <a href="../components/admin_logout.php" onclick="return confirm('deseja sair agora?');" class="delete-btn">sair</a>
         <?php
            }else{
         ?>
...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="../components/admin_logout.php" onclick="return confirm('deseja sair agora?');"><i class="fas fa-right-from-bracket"></i><span>Sair</span></a>
   </nav>
