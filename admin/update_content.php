...
<section class="video-form">
   ...
   <h1 class="heading">alterar conteúdo</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>alterar status <span>*</span></p>
      <select name="status" class="box" required>
         <option value="<?= $fecth_videos['status']; ?>" selected><?= $fecth_videos['status']; ?></option>
         <option value="active">ativo</option>
         <option value="deactive">inativo</option>
      </select>
      <p>alterar titulo <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="digite o titulo" class="box" value="<?= $fecth_videos['title']; ?>">
      <p>alterar descrição <span>*</span></p>
      ...
      <input type="submit" value="alterar conteúdo" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">visualizar conteúdo</a>
   ...
   <?php
         ...
         echo '<p class="empty">video não encontrado! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">adicionar vídeos</a></p>';
      }
   ?>
