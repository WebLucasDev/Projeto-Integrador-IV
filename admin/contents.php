...
<section class="contents">
   ...
   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">crie um novo conteúdo</h3>
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="deletar" class="delete-btn" onclick="return confirm('deseja deletar esse conteúdo?');" name="delete_video">
         </form>
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">ver conteúdo</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">nenhum conteúdo adicionado até o momento!</p>';
      }
   ?>
