   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">alterar playlist</a>
            <input type="submit" value="deletar playlist" class="delete-btn" onclick="return confirm('delete this playlist?');" name="delete">
         </form>
      </div>
   </div>
   <?php
...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">assistir vídeos</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">nenhum vídeo adicionado até o momento! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">adicionar vídeos</a></p>';
      }
   ?>
