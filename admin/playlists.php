...
if(isset($_POST['delete'])){
   ...
   $message[] = 'playlist deletada!';
      ...
      $message[] = 'playlist já cadastrada!';
   }
}
...
<section class="playlists">
   ...
   <h1 class="heading">adicionar playlists</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">crie uma nova playlist</h3>
         <a href="add_playlist.php" class="btn">adicionar playlist</a>
      </div>
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">modificar</a>
            <input type="submit" value="deletar" class="delete-btn" onclick="return confirm('deseja mesmo deletar essa playlist?');" name="delete">
         </form>
      ...
      <?php
         ...
         echo '<p class="empty">nenhuma playlist adicionada até o momento!</p>';
      }
      ?>
