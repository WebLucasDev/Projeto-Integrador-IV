...
<head>
   ...
   <title>Perfis de Professores</title>
...
<section class="tutor-profile">
   ...
   <div class="details">
      ...
      <div class="flex">
         ...
         <p>total de conteúdos : <span><?= $total_contents; ?></span></p>
...
<section class="courses">
   ...
   <h1 class="heading">Próximos Cursos</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="playlist.php?get_id=<?= $course_id; ?>" class="inline-btn">veja a playlist</a>
      </div>
      <?php
         }
      }else{
